...
{
{text = '✭ سورس جنازه ✭', url = 't.me/SOURCE_GNAZH '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/GNA_I '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("GNA_I")
...
local TestText = "*✯ مبرمج سورس جنازه ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/GNA_I"}
},
}
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𓏺𝐆𝐍𝐀𝐙𝐇](t.me/SOURCE_GNAZH )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/GNA_I '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/GNA_I'},
},
{
{text = '• قناة التحديثات •', url = 't.me/SOURCE_GNAZH '},
},
{  
