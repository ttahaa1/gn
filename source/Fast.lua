...
msg.Name_Controller = 'المبرمج جنازه ❤️‍🔥  '
...
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج جنازه نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
...
local caption = "اليك قائمه مطورين سورس جنازه :"
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/SOURCE_GNAZH ", 'md', true)
end
...
if text == 'لولا' or text == 'مرات الجنازه' then
...
{
{text = '‹ MRAET 𓏺𝐆𝐍𝐀𝐙𝐇 › .', url = "https://t.me/merat_caser"}
},
{
{text = ' ⛥𓏺𝐆𝐍𝐀𝐙𝐇⛥ ', url = "https://t.me/GNA_I"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'جنازه' or text == 'المبرمج جنازه' then
photo = "https://t.me/GNA_I"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/GNA_I )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ ٰ𖣂 • BOT 𓏺𝐆𝐍𝐀𝐙𝐇 • 𖣂 ›', url = "https://t.me/caserbotbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ💸 ⇣ الاوامر البنكيه ⇣ 💸 › .', url = "https://t.me/d_b_b_y/8"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'جنازه' or text  == 'المبرمج جنازه' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(5986905034,0,'*\n◉  مرحباً عزيزتي لولا قلب الجنازه هناك \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝐒𝐎𝐔𝐑𝐂𝐄 𓏺𝐆𝐍𝐀𝐙𝐇━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
if msg.sender_id.user_id == tonumber(6264438859) then
send(msg_chat_id,msg_id,"❍ انت جنازه مطور السورس يقلبي🌚♥","md",true)
...
send(msg_chat_id,msg_id,"انتي [لولا مرات جنازه] يقلبي 🥺♥","md",true)
...
{{text = '- 𝐒𝐎𝐔𝐑𝐂𝐄 𓏺𝐆𝐍𝐀𝐙𝐇 •', url = "https://t.me/SOURCE_GNAZH"}},
}
}
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس 𓏺𝐆𝐍𝐀𝐙𝐇\nاكتب اسمك الان :',"md",true)  
end
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/SOURCE_GNAZH"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@SOURCE_GNAZH")
sleep(1)
...
if text == 'جنازه' or text == 'مبرمج السورس' or text == 'gnazh' then  
...
data = {
{
{text = '𓆩 ˹ [𝐒𝐎𝐔𝐑𝐂𝐄 𓏺𝐆𝐍𝐀𝐙𝐇] ˼ 𓆪', url = "https://t.me/SOURCE_GNAZH"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 [𝙲𝙷] Gnazh 𝚂𝙾𝚄𝚁𝙲𝙴 ❭• °](t.me/SOURCE_GNAZH )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[جنازه]")..
'\n🎧╢• لأستخدام البوت اغاني وفيديو كول '..
'\n🎥╢• اكتب » /music ثم أضغط الأوامر .'..
'\n🕹╢اكتب /GNAZH لاظهار كيبورد الاعضاء '..
...
'\n📣╢• ــــــــــــــــــــ𝐒𝐎𝐔𝐑𝐂𝐄 ــــــــــــــــ𓏺𝐆𝐍𝐀𝐙𝐇 '..
'\n📣╢• تأكد » من تفعيل الرفع '..
